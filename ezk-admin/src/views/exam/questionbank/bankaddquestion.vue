  ...
  <div class="main-container">
    <el-form ref="form" label-width="80px">
      <el-form-item label="选择题目">
        <el-button type="primary" @click="showDialog">题目列表</el-button>
      </el-form-item>
      <el-form-item>
      ...
      <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column label="操作" align="center" width="110px">
          <template slot-scope="{row}">
            <el-button size="mini"   @click="addToIds(row)">添加</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    // 关联题目
    onSubmit () {
      this.$axios.post(`/api/examsystem/tquestionbank/addQuestion`, { 'bankId': this.bankId, 'questionIds': this.questionIds }).then(res => {
        this.$message.success('添加成功')
        this.$router.push('/exam/questionbank/list')
      })
    },
