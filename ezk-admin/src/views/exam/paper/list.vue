  ...
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        ...
        <router-link :to="{ path: '/exam/paper/autocreate' }" class="link-left">
          <el-button type="primary">智能组卷</el-button>
        </router-link>
      </el-form-item>
    </el-form>
    <el-table
    ...
    >
      ...
      <el-table-column prop="score" label="总分" width="150px" align="center" />
      <!--<el-table-column prop="createUser" label="创建人id" width="150px" align="center" />-->
      <el-table-column
        prop="createTime"
        label="创建时间"
        align="center"
...
<!--          <router-link :to="{ path: `/task/manage/publish?id=${row.id}&name=${row.name}` }" class="link-left">-->
<!--            <el-button size="mini">发布考试</el-button>-->
<!--          </router-link>-->
          <el-button
            size="mini"
            @click="
