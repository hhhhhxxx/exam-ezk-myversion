<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item>
         <span style="color: gainsboro;display: flex">
            <p style="margin: 5px">验证码:</p>
           <el-input style="width: 150px" v-model="loginForm.code" class="lowin-input" type="text" tabindex="1" auto-complete="on"/>
...
import { CHANGE_SESSION } from '@/store/mutations'
  ...
  methods: {
    getCaptcha(){
      loginApi.getCaptcha().then(res=>{
        this.captchaImg = res.content.captchaImg
        this.loginForm.capthchaKey = res.content.CapthchaKey
      })
    },
