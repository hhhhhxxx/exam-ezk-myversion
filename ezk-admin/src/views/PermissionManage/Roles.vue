  ...
  methods: {
    ...
    handleDelete (index, row) {
      this.$confirm('是否要删除该角色?', '提示', {
        ...
        bossApi.deleteRole(row.id).then((response) => {
          this.$message({
            type: 'success',
            message: '删除成功!'
          })
    ...
    handleDialogConfirm () {
      if (this.isEdit) {
        bossApi.saveOrUpdate(this.role).then((response) => {
          this.$message({
            message: '修改成功！',
            type: 'success'
          })
        ...
        bossApi.saveOrUpdateRole(this.role).then((response) => {
          this.$message({
            message: '添加成功！',
            type: 'success'
          })
    ...
    getList () {
      ...
      bossApi.getRolePages(this.listQuery).then((response) => {
