    ...
    >
      ...
      <el-table-column width="250px" label="操作" align="center">
        <template slot-scope="{ row }">
          ...
          <router-link
            :to="{ path: '/user/teacher/edit', query: { id: row.id } }"
            class="link-left"
          >
...
export default {
  ...
  methods: {
    ...
    // 年级格式化方法,1代表1年级，2代表二年级，3代表三年级，4代表四年级，以此类推
    ...
    // 是在操作栏中根据status来显示按钮的文字，1为禁用，2为启用
