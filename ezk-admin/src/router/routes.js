    ...
    children: [
      {
        ...
        meta: { title: '学生列表', noCache: true, requireAuth: true }
      },
      {
        path: 'student/edit',
      ...
      },
      {
        ...
        meta: { title: '教师列表', noCache: true, requireAuth: true }
      },
      {
        path: 'teacher/edit',
        component: () => import('@/views/user/teacher/edit'),
        name: 'TeacherPageEdit',
        meta: { title: '教师编辑', noCache: true, activeMenu: '/user/teacher/list', requireAuth: true },
        hidden: true
      },
      {
        path: 'admin/list',
        ...
        meta: { title: '管理员列表', noCache: true, requireAuth: true }
      },
      {
        path: 'admin/edit',
    ...
    children: [
      {
        ...
        name: 'Users',
        meta: { title: '用户管理', noCache: true, requireAuth: true }
      },
      {
        path: 'role',
        name: 'Role',
