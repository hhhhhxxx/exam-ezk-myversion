...
import com.jdpu.common.param.admin.file.UeditorConfigVM;
import com.jdpu.common.param.admin.file.UploadResultVM;
import com.jdpu.common.entity.vo.RestResponse;
import com.jdpu.userservice.config.SystemConfig;
...
public class AdminUploadController extends UserBaseApiController {
    ...
    @Autowired
    public AdminUploadController(FileUpload fileUpload, SystemConfig systemConfig, UserService userService) {
