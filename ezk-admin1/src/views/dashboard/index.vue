    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div
            ...
            @mouseover="classLoading1 = true"
            @mouseleave="classLoading1 = false"
            v-bind:class="
              classLoading1 ? 'animate__animated animate__rubberBand' : ''
            "
          >
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div
            class="card-panel-description"
            @mouseover="classLoading4 = true"
            @mouseleave="classLoading4 = false"
            v-bind:class="
              classLoading4 ? 'animate__animated animate__rubberBand' : ''
            "
          >
...
export default {
  ...
  mounted () {
    ...
    dashboardApi.index().then((re) => {
      ...
      _this.echartsQuestion.setOption(
        this.option(
          '题目月数量',
          '{b}日{c}题',
          response.mothDayText,
