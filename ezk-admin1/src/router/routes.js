...
export const asyncRouterMap = [
    ...
    children: [
      {
        ...
        name: 'MyClassList',
        meta: { title: '我的班级', noCache: true, requireAuth: true }
      },
      {
        path: 'allClassList',
        component: () => import('@/views/class/allClassList'),
        name: 'AllClassList',
        meta: { title: '所有班级', noCache: true, requireAuth: true }
      },
      {
        path: 'edit',
      ...
      {
        path: 'teacher/list',
        component: () => import('@/views/class/teacherList'),
        name: 'StudentInClass',
        meta: { title: '班内老师', noCache: true, requireAuth: true },
        hidden: true
      }
    ]
  },
  ...
  // 菜单列表
  {
    ...
    children: [
      {
        path: 'user/list',
        component: () => import('@/views/PermissionManage/user/list'),
        name: 'UserPage',
        meta: { title: '用户列表', noCache: true, requireAuth: true }
      },
      {
        path: 'user/edit',
        component: () => import('@/views/PermissionManage/user/edit'),
        name: 'UserEdit',
        meta: {
          title: '用户编辑',
          noCache: true,
      ...
      },
      {
        ...
        name: 'Role',
        component: () =>
          import('@/views/PermissionManage/role/Roles'),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'allocMenu' */ '@/views/PermissionManage/role/AllocMenu'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'allocResource' */ '@/views/PermissionManage/role/AllocResource'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'menu' */ '@/views/PermissionManage/menu/Menus'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'menuAdd' */ '@/views/PermissionManage/menu/AddMenu'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'menuUpdate' */ '@/views/PermissionManage/menu/UpdateMenu'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'resource' */ '@/views/PermissionManage/resources/Resources'
            ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: 'categoryList' */ '@/views/PermissionManage/resources/CategoryList'
            ),
    ...
    children: [
      {
        ...
        name: 'Profile',
        meta: { title: '个人简介', icon: 'user', noCache: true, base: true } // 不用验证
      }
    ]
  },
