...
const request = function (loadtip, query) {
  ...
  return axios.request(query).then(res => {
    ...
    .catch(e => {
      ...
      vue.prototype.$message.error('request的message:' + e.message)
...
const post = function (url, params) {
  const query = {
    ...
    timeout: 30000,
    data: params,
    headers: { 'Content-Type': 'application/json', 'request-ajax': true, 'Authorization': axios.defaults.headers.Authorization }
  }
  return request(false, query)
}
...
const get = function (url, params) {
  const query = {
    ...
    timeout: 30000,
    params: params,
    headers: { 'request-ajax': true, 'Authorization': axios.defaults.headers.Authorization }
  }
  return request(false, query)
}
...
const form = function (url, params) {
  const query = {
    ...
    timeout: 30000,
    data: params,
    headers: { 'Content-Type': 'multipart/form-data', 'request-ajax': true, 'Authorization': axios.defaults.headers.Authorization }
  }
  return request(false, query)
}
