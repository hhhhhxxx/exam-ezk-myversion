...
import com.jdpu.common.param.admin.dashboard.IndexVM;
...
public class AdminDashboardController  {
    ...
    @Autowired
    public AdminDashboardController(ExamPaperService examPaperService, QuestionService questionService, ExamPaperAnswerService examPaperAnswerService, ExamPaperQuestionCustomerAnswerService examPaperQuestionCustomerAnswerService,UserEventLogService userEventLogService) {
